package
{
   ...
   public class Codec
   {
      ...
      public static function load(param1:String, param2:*, param3:Function, param4:int = 0) : void
      {
         var url:String = param1;
         var params:* = param2;
         var onData:Function = param3;
         var retry:int = param4;
         var _loc5_:Http = new Http(url);
         var c:Codec = new Codec();
         _loc5_.setParameter("__d",c.serialize(params));
         ...
         _loc5_.onError = function(param1:String):void
         {
            if(retry > 0)
            {
               Codec.load(url,params,onData,retry - 1);
            }
            else
            {
