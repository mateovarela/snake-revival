package mt.data
{
   ...
   public class Mods
   {
      ...
      public static function decode(param1:Bytes) : String
      {
         ...
         var _loc10_:int = 0;
         var _loc11_:int = 0;
         var _loc2_:Bytes = Mods.§&7\x16d\x03§(param1.sub(0,5).toString());
         var _loc3_:String = param1.sub(5,4).toString();
         var _loc4_:int = int(_loc2_.b[0]);
         var _loc5_:int = int(_loc2_.b[1]);
         var _loc6_:Bytes = param1.sub(9,param1.length - 9);
         var _loc7_:int = 0;
         ...
         if(_loc3_.charCodeAt(0) != Mods.ENCODE.charCodeAt(_loc7_ & 63) || _loc3_.charCodeAt(1) != Mods.ENCODE.charCodeAt(_loc7_ >> 6 & 63) || _loc3_.charCodeAt(2) != Mods.ENCODE.charCodeAt(_loc7_ >> 12 & 63) || _loc3_.charCodeAt(3) != Mods.ENCODE.charCodeAt(_loc7_ >> 18 & 63))
         {
      ...
      public static function extract(param1:String, param2:Array, param3:Array) : Array
      {
         ...
         var _loc4_:Bytes = Resource.getBytes(param1);
         var _loc5_:String = Mods.decode(_loc4_);
         ...
         _loc6_.setResolver({
            ...
            {
               return §S[vi\x03§[Std.parseInt(param1.substr(1))];
            }
         });
