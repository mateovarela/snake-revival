package mt.bumdum9
{
   ...
   public class Col
   {
      ...
      public static function ___setRGBValues(param1:int) : Object
      {
         return {
            "r":param1 >> 16,
            "g":param1 >> 8 & 255,
      ...
      public static function ___setRGBAValues(param1:int) : Object
      {
         return {
            "a":param1 >>> 24,
            "r":param1 >> 16 & 255,
      ...
      public static function setPercentColor(param1:DisplayObject, param2:Number, param3:int, param4:Object = undefined) : void
      {
         ...
         var _loc5_:* = Col.___setRGBValues(param3);
      ...
      {
         var _loc4_:* = Col.___setRGBAValues(param2);
      ...
      public static function mergeCol(param1:int, param2:int, param3:Object = undefined) : int
      {
         ...
         var _loc4_:* = Col.___setRGBValues(param1);
         var _loc5_:* = Col.___setRGBValues(param2);
         var _loc6_:* = {
      ...
      public static function mergeCol32(param1:int, param2:int, param3:Object = undefined) : int
      {
         ...
         var _loc4_:* = Col.___setRGBAValues(param1);
         var _loc5_:* = Col.___setRGBAValues(param2);
         var _loc6_:* = {
            "r":int(Number(int(_loc4_.r) * param3 + int(_loc5_.r) * (1 - param3))),
            "g":int(Number(int(_loc4_.g) * param3 + int(_loc5_.g) * (1 - param3))),
            "b":int(Number(int(_loc4_.b) * param3 + int(_loc5_.b) * (1 - param3))),
      ...
      {
         var _loc3_:* = Col.___setRGBValues(param1);
