package pix
{
   ...
   public class Store
   {
      ...
      public var timelines:Hash;
      
      public var texture:BitmapData;
      
      public var lastIndex:int;
      
      public var index:Hash;
      ...
      public function Store(param1:BitmapData = undefined)
      {
      ...
      public function ADGgz(param1:int = 0, param2:int = 0) : void
      {
         ddx = param1;
         ddy = param2;
      }
      ...
      public function getAnims(param1:Array) : Array
      {
         ...
         while(_loc3_ < int(param1.length))
         {
            ...
            _loc5_.timeline = timelines.get(_loc4_);
            _loc2_.push(_loc5_);
         }
         return _loc2_;
      }
      ...
      public function getAnim(param1:String) : Anim
      {
         ...
         _loc2_.timeline = timelines.get(param1);
         return _loc2_;
      }
