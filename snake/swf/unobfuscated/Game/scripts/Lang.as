package
{
   ...
   public class Lang implements §Xew§
   {
      ...
      public static var _x_FAMILLES:Array = ["sucre","rouge","feuille","petit","noix","fleur","agrume","vert","liane","alien","baie","long","courge","poire","bleu","pomme","crotte","orange","jaune","rose"];
      ...
      public static var §S0\x1ei\x03§:Array = ["temps de jeu","fruits ramassés","frutibar maximum","longueur maximum"];
      ...
      public static var §\x13;\x1bs\x03§:String = "Connexion impossible";
      ...
      public static var § U\x05\x18\x01§:String;
      ...
      public static function _x_getName(param1:String) : String
      {
         return §\x0b\b\x0bq\x02§.§T\x06j'\x03§(param1);
      }
